...
% 0, 0.5, and 1.
set(gca,'xtick',min(struct.qr):0.5:max(struct.qr));
set(gca,'ytick',min(struct.qz):0.5:max(struct.qz));
set(gca,'xticklabel',min(struct.qr):0.5:max(struct.qr));
set(gca,'yticklabel',min(struct.qz):0.5:max(struct.qz));
set(gca,'tickdir','out');
